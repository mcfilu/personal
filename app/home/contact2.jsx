  ...
  return (
    <div className='w-full h-[70vh] flex flex-row bg-gradient-to-tl from-black via-zinc-800 to-black p-4'>
        <div className='h-full w-[40vw] flex flex-col pl-[5vw] justify-center'>
            <h2 className='text-[7vh] md:text-[8vh] leading-tight text-white font-display'>Contact</h2>
            <h2 className='text-[7vh] md:text-[8vh] leading-tight text-white font-display'>Me</h2>
