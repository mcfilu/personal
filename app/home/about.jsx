...
const About = () => {
  return (
    <div id="about" className='w-full flex flex-row justify-center'>
        <div className='w-1/2 h-ful relative bg-gradient-to-br from-black via-zinc-800 to-black'>
            <Image fill objectFit='cover' alt="" src="/images/me_no_bg.png" ></Image>
        </div>
        <div className='w-1/2 h-full flex flex-col bg-gradient-to-tl from-black via-zinc-800 to-black justify-center p-10 py-[10vh]'>
