...
const About = () => {
  return (
    <div className='w-full h-screen flex flex-row'>
        ...
        <div className='w-1/2 h-full flex flex-col bg-gradient-to-tl from-black via-zinc-600 to-black justify-center p-10'>
            <h2 className='text-7xl text-white'>Filip</h2>
            <h2 className='text-7xl text-white'>Olszewski</h2>
